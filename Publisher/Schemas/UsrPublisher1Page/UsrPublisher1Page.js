            ...
            validatePublishingHouse: function (callback, scope) {
                Terrasoft.SysSettings.querySysSettingsItem("MaxCountActiveEveryDayPublish", function (maxCount) {
                    ...
                    esq.getEntityCollection(function (response) {
                        ...
                        var hasChangedProperty = (this.changedValues.hasOwnProperty("UsrActive") || this.changedValues.hasOwnProperty("UsrPereodicity"));
                        if (hasChangedProperty && pereodicity === "Ежедневно" && isActive && count >= maxCount) {
